...
# função para consultar todas as turmas
...
# função para consultar todas os alunos
def aluno_por_turma():
...
# função para consultar todas as aulas
def aulas_por_turma():
    if verificar_vazio(turma_list,"turma"):
        return
...
# função para consultar todas as atividades
